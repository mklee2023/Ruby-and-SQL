...
# Function SELECT *FROM companies WHERE state = 'CA';
# which is equal to the Ruby code below
ca_company = Company.where({"state"=>"CA"})

# Function SELECT *FROM companies WHERE name = 'Apple' LIMIT 1;
# which is equal to the Ruby code below
